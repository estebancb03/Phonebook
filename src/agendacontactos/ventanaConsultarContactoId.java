...
public class ventanaConsultarContactoId extends javax.swing.JFrame {

    //Se instancian clases 
    modeloDatosContactos mdc = new modeloDatosContactos();
    
    //Constructor
    public ventanaConsultarContactoId() {
...
//------------------------------------------------------------------------------        
    ...
    private void initComponents() {
        ...
        jLabelTitulo.setText("Consultar contacto (Identificación)");
        ...
        jPanelPrincipal1.add(jSeparatorPrincipal, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 50, 500, 10));
        ...
        jPanelPrincipal1.add(jButtonAtras, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 280, 130, 50));
        ...
        jPanelPrincipal1.add(jButtonLimpiar, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 280, 120, 50));
        ...
        jPanelPrincipal1.add(jSeparatorPrincipal2, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 380, 250, 20));
        jPanelPrincipal1.add(jSeparatorPrincipal4, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 280, 250, 10));

        jSeparatorPrincipal5.setOrientation(javax.swing.SwingConstants.VERTICAL);
        jPanelPrincipal1.add(jSeparatorPrincipal5, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 280, 10, 50));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ventanaConsultarContactoId.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                ...
                new ventanaConsultarContactoId().setVisible(true);
            }
        });
    }
