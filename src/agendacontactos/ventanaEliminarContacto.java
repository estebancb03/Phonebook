/*
    ...
    Descripción: clase JFrame para eliminar un contacto co una determinada
                 "IDENTIFICACION"
 */
...
public class ventanaEliminarContacto extends javax.swing.JFrame {
...
//------------------------------------------------------------------------------
    ...
    } //Fin del método "bloquearObjetos"
    ...
    public void eliminaContacto(java.awt.event.ActionEvent e){
        ...
        try{
            ...
            if(rs != null){
                ...
                if(JOptionPane.showConfirmDialog(null,"¿Está seguro de eliminar este contacto?") == JOptionPane.OK_OPTION){
                    
                    if(mdc.eliminarDatos(jTextFieldId.getText()) == true){
                        
                        JOptionPane.showMessageDialog(null,"El contacto ha sido eliminado correctamente","Infomacion",
                        ...
                        JOptionPane.showMessageDialog(null,"El contacto NO ha sido eliminado","Advertencia",
...
//------------------------------------------------------------------------------        
    ...
    private void initComponents() {
        ...
        jLabelTitulo.setText("Eliminar Contacto");
        jPanelPrincipal1.add(jLabelTitulo, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 10, 410, -1));
        ...
        jPanelPrincipal1.add(jLabelCategoria, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 300, -1, 50));
        ...
        jPanelPrincipal1.add(jButtonBuscar, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 330, 120, 50));
        jPanelPrincipal1.add(jSeparatorPrincipal1, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 280, 250, 10));
        ...
        jPanelPrincipal1.add(jTextFieldNumContacto, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 110, 140, -1));
        ...
        jPanelPrincipal1.add(jLabelNumContacto, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 100, -1, 40));
        ...
        jPanelPrincipal1.add(jButtonEliminar, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 330, 130, 50));

        jSeparatorPrincipal2.setOrientation(javax.swing.SwingConstants.VERTICAL);
        jPanelPrincipal1.add(jSeparatorPrincipal2, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 280, 10, 100));
        jPanelPrincipal1.add(jSeparatorPrincipal3, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 330, 250, 20));
        jPanelPrincipal1.add(jSeparatorPrincipal4, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 380, 250, 20));

        getContentPane().add(jPanelPrincipal1, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 40, 610, 410));
    ...
    private void jButtonBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonBuscarActionPerformed
        ...
        if(jTextFieldId.getText().equals("")){
            ...
            if(mdc.buscarId(jTextFieldId.getText()) == true){
                ...
                JOptionPane.showMessageDialog(null, "Contacto encontrado, se mostraran sus datos", "Informacion", 
                JOptionPane.INFORMATION_MESSAGE,new javax.swing.ImageIcon(getClass().getResource("/Imagenes/informacion.png")));
                mdc.mostrarDatosId(jTextFieldId.getText(),jTextFieldNumContacto,jTextFieldNombre,jTextFieldApellido1,jTextFieldApellido2, 
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ventanaEliminarContacto.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                ...
                new ventanaEliminarContacto().setVisible(true);
            }
        });
    }
...
} // Fin de "ventanaEliminarContacto"
