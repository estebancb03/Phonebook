...
public class ventanaVisualizarTodosContactos extends javax.swing.JFrame {

    //Se instancian clases 
    modeloDatosVisualizar mdv = new modeloDatosVisualizar();
    
    //Constructor
    public ventanaVisualizarTodosContactos() {
        
        initComponents();
        this.setLocationRelativeTo(null); //Ubica el JFrame en el centro de la pantalla
        mdv.cargarTablaTodosContactos(jTableTodosContactos);
    }
//------------------------------------------------------------------------------
...
//------------------------------------------------------------------------------        
    ...
    private void initComponents() {
        ...
        jTableTodosContactos = new javax.swing.JTable();
        ...
        jLabelTitulo.setText("Visualizar todos los contactos");
        ...
        jTableTodosContactos.setBackground(new java.awt.Color(0, 0, 0));
        jTableTodosContactos.setForeground(new java.awt.Color(255, 255, 255));
        jTableTodosContactos.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
            ...
            new String [] {
                "Identificacion", "Nombre", "Apellido", "Pais", "Tel. Movil"
            }
        ) {
        ...
        jTableTodosContactos.setSelectionForeground(new java.awt.Color(0, 0, 0));
        jScrollPane1.setViewportView(jTableTodosContactos);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ventanaVisualizarTodosContactos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                ...
                new ventanaVisualizarTodosContactos().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTable jTableTodosContactos;
