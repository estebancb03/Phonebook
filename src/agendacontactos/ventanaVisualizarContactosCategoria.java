/*
    ...
    Descripción: clase JFrame para visualizar contactos de acuerdo a una categoría
 */
package agendacontactos;
import javax.swing.JOptionPane;

public class ventanaVisualizarContactosCategoria extends javax.swing.JFrame {

    //Se instancian clases 
    modeloDatosVisualizar mdv = new modeloDatosVisualizar();
    
    //Constructor
    public ventanaVisualizarContactosCategoria() {
...
//------------------------------------------------------------------------------
    ...
    } //Fin método "cargarComboCategoria"
...
//------------------------------------------------------------------------------        
    ...
    private void initComponents() {
        ...
        jLabelTitulo.setText("Visualizar contactos por categoría");
        ...
        jTableUsuariosNivel.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Nombre", "Apellido", "Tel. Fijo", "Tel. Móvil", "Categoría"
            }
        ) {
        ...
        jLabelNombre.setText("Categoría");
        ...
        jPanelPrincipal1.add(jComboBoxCategoria, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 80, 180, 30));
    ...
    private void jButtonLimpiarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonLimpiarActionPerformed
        ...
        new ventanaVisualizarContactosCategoria().setVisible(true);
    ...
    private void jButtonBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonBuscarActionPerformed
        ...
        new ventanaVisualizarContactosCategoria().setVisible(true);
        this.setVisible(false);
        String categoriaContacto = "";
        categoriaContacto = String.valueOf(jComboBoxCategoria.getSelectedItem());
        mdv.cargarTablaContactosCategoria(jTableUsuariosNivel,categoriaContacto);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ventanaVisualizarContactosCategoria.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
